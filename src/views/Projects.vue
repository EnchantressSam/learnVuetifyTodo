<template>
  <div class="projects">
    <h1 class="subtitle-1 grey--text--text">Projects</h1>
...
export default {
    data() {
      return {
        ...
        {title: 'Create a community forum', person: 'Max', due: '22th Jan 2020', status: 'overdue', content: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odio asperiores atque praesentium dignissimos debitis reiciendis, voluptas placeat quod qui blanditiis nobis tempora repellat explicabo eius temporibus nihil laudantium eveniet expedita.'},
        {title: 'Design a new website.. again', person: 'Enchantress', due: '21th Feb 2020', status: 'ongoing', content: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore hic in quam natus deserunt temporibus eligendi est placeat ipsam aliquam vel qui, mollitia autem laudantium minus. Culpa sunt unde et!'},
      ]
      }
    },
    computed: {
      myProjects(){
        return this.projects.filter(project =>{
          return project.person === 'Enchantress'
        })
      }
    },
  }
